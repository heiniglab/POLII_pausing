...
###
create.supplementary.tables <- function(){
  ...
  sub.factor.feature.spaces <- 
    build.sequence.specific.biologically.functional.feature.sub.spaces(stratify = sub.factor.feature.spaces)
  sub.factor.feature.spaces <- sub.factor.feature.spaces[c("Chromatin", "Initiation", "Elongation", "Termination", "Processing","Splicing", "7SK.Binding", "Elongation+7SK")]
  ...
  sub.factor.feature.spaces <- build.pausing.associated.factor.sub.feature.spaces()
  rn7sk.factors <- unique(unlist(sub.factor.feature.spaces["7SK.Binding"]))
  ...
  lapply(CARGS$cell.line, function(cline){
    lapply(sub.factor.feature.spaces[["7SK.Binding"]][[cline]], function(factor){
